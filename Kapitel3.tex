...
%Taelle zu Übersicht der Stichprobe
\begin{table}[htbp]
	\centering
...
\begin{table}[H]
	...
	\label{fdelay}%
\end{table}%
Die Mehrheit der untersuchten Projekte konnte die Zeitvereinbarungen im MS2 einhalten. Dieses Verhältnis ändert sich bei Erreichung des MS8 und steigt bei MS10 so an, dass letztendlich der Grossteil der Projekte zeitverzögert abgeschlossen wird (783 Projekte respektive 86\%).
\begin{table}[H]
	\centering
	\caption{Zeitverzögerung}
	\begin{tabular}{lrrrr}
...
Die mittlere Abweichung des OR vom Budget des Geschäftseinheit und der Region der Tabelle waren für Fail-Projekte in absoluten und relativen Grössen höher als für Success Projekte.  
%%
%%
